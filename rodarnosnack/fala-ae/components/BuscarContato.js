...
export default function BuscarContato({ usuarioAtual, aoVoltar }) {
  ...
  async function buscarEEnviarSolicitacao() {
    ...
    if (idDestinatario === usuarioAtual.id) {
      setFeedback('Você não pode iniciar conversa consigo mesmo!');
      setVisivel(true);
      setProcessando(false);
      return;
    }
  ...
  return (
    <View style={estilos.fundo}>
      <Text style={estilos.titulo}>Iniciar nova conversa</Text>
      <TextInput
